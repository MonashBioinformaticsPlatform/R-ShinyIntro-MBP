...
Create a new .R file, paste the following code inside, save it as app.R inside the folder `app_hello`. (RStudio recognizes this is a shiny app, because of the file name `app.R` and the format of the script within, a Run App button appears upon saving)
