...
### Challenge 6: Our collaborator saw the app we have created to show the relationship between two samples. They wants a tabular view of the data along with the plot to look at expression of individual genes in the samples. Modify your app to display the tabular data in the final output. (breakout). {- .challenge}
