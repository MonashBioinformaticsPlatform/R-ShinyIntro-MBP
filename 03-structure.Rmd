...
> Now, open the `widgets.R` inside `ShinyApps` folder, and try running it. We have different types of widgets you can use in Shiny Apps. Have a go at them!! 
Please Note: For now, keep the `Server Logic` and `Run the App` as it is. We'll explain this in next sections.
